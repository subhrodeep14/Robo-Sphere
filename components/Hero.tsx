...
const Header = () => {
  return (
    ...
    flex items-center w-full overflow-hidden' style={{backgroundImage:'url("/hero.png")'}}>
      <Navbar/>
      <motion.div 
      ...
      className='container text-left mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        <h2 className='text-5xl sm:text-6x md:text-[82px] inline-block max-w-3xl font-semibold pt-20'>Explore <span className='text-[#ED4073]'>Technology</span> homes that fit yours dreams</h2>
