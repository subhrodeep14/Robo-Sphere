          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <img src="finallogow.png" alt="Logo" className="h-25 w-55" />
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">director@therobosphere.co.in</span>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    target='_blank'
                    className="p-3 bg-gray-800 hover:bg-gradient-to-r hover:from-pink-500 hover:to-blue-600 rounded-lg transition-all group"
