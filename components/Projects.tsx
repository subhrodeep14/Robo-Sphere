...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-24 bg-gradient-to-br from-gray-50 via-pink-50 to-rose-50 dark:from-gray-900 dark:via-pink-900/20 dark:to-rose-900/20">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 py-1 bg-pink-100 dark:bg-pink-900/50 text-pink-700 dark:text-pink-300 text-xs rounded-lg"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group/btn w-full bg-gradient-to-r from-pink-600 to-rose-600 text-white py-3 rounded-xl font-semibold flex items-center justify-center space-x-2 hover:shadow-lg transition-all"
                >
